    ...
    <section id="projects" className="relative px-4 py-24">
      <div className="container mx-auto max-w-5xl">
        ...
        <p className="text-muted-foreground mx-auto mb-12 max-w-2xl text-center">
          ...
          crafted with attention to detail, perfotmance and user experience.
        </p>
              ...
              <div className="p-6">
                <div className="mb-4 flex flex-wrap gap-2">
                  {project.tags.map((tag) => (
                    <span className="bg-secondary-foreground rounded-full border px-2 py-1 text-xs font-medium">
                      {tag}
                    </span>
                  ))}
                </div>
        ...
        <div className="mt-12 text-center">
          <a
            ...
            className="cosmic-button mx-auto flex w-fit items-center gap-2.5"
            target="_blank"
          >
